(function () {
  ...
  function refreshMotionBindings() {
    ...
    document.querySelectorAll('.fusion-nav nav a, .final-nav__contact, .fusion-hero__bottom a, .fusion-contact__row a, .fusion-contact__row button, .cases-nav__back, .cases-filters button, .cases-next a, .humanizm-brand, .humanizm-menu-button, .humanizm-menu nav a, .humanizm-privacy-note a, .humanizm-privacy-note button').forEach(bindMagnetic);
  }

(function () {
  ...
  var translations = {
    ru: {
      ...
      projectGame: 'Игровой сайт с двумя выпущенными играми в RuStore. Веду идею, требования, постановку задач Codex, ручную проверку, ретест и публикацию.',
    ...
    en: {
      ...
      projectGame: 'A game hub with two titles released on RuStore. I own the concept, requirements, Codex tasks, manual checks, retests and publication.',
  ...
  function setLanguage(language, persist) {
    ...
    document.querySelectorAll('[data-games-link]').forEach(function (link) {
      link.setAttribute('href', 'https://kezerio.github.io/?lang=' + selected);
    });
  ...
  function copyEmail() {
    var address = 'aniyurotaxo084@gmail.com';
